 ...
 *
 * This shows how 6 tetrahedra are carved out of a cube, and why they don't perfectly tessellate the space, leaving gaps
...
public class T8CodeGapVisualization extends Application {
    ...
    private final        Color[]  TET_COLORS   = { Color.RED.deriveColor(0, 1, 1, 0.7), Color.GREEN.deriveColor(0, 1, 1,
                                                                                                                0.7),
                                                   Color.BLUE.deriveColor(0, 1, 1, 0.7), Color.YELLOW.deriveColor(0, 1,
                                                                                                                  1,
                                                                                                                  0.7),
                                                   Color.MAGENTA.deriveColor(0, 1, 1, 0.7), Color.CYAN.deriveColor(0, 1,
                                                                                                                   1,
                                                                                                                   0.7) };
    // UI controls
    ...
    private void analyzeCoverage() {
        ...
        "Coverage Analysis:\n" + "• Gaps: %.1f%%\n" + "• Correct (1 tet): %.1f%%\n" + "• Overlaps (2+ tets): %.1f%%\n\n"
        + "This is why t8code has\n" + "containment issues!", gapPercent, correctPercent, overlapPercent));
    }
    ...
    private VBox createControls() {
        ...
        controls.getChildren().addAll(title, sep1, tetLabel, tetControls, sep2, transLabel, transparencySlider, sep3,
                                      showGapsCheckBox, showOverlapsCheckBox, analyzeButton, sep4, infoLabel,
                                      helpLabel);
    ...
    private void createWireframeCube() {
        ...
        cubeWireframe.getChildren().addAll(edge1, edge2, edge3, edge4, edge5, edge6, edge7, edge8, edge9, edge10,
                                           edge11, edge12);
    }
