...
/**
 * Composable transform. This is a Translate, followed by the transform to the orientation and then finally the scaling.
 * This class is designed to be chained together to perform complex transformations and then to apply these
