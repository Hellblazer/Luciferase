...
public class VectorMath {
     ...
     *
     * @param start The vector being subtracted.
     * @param end   The vector we are subtracting from.
    ...
    /**
     * Returns the parametric interpolation of two vectors for parameter 0 <= t <= 1. At t = 0 this returns the start,
     * and at t = 1 returns the end. In general, this returns start + (end - start) * t.
     *
    ...
    /**
     * Returns true if the given vector is the zero vector, within a small margin of error (component-wise).
     *
     * @param vector The vector we are comparing to zero.
