...
/**
 * A Rhombic Dodecahedron Grid Coordinate System (RDGCS). This is the Face Center Cubic Grid. This grid encapsulates how
 * to convert to and from the cubic and rhombic dodecahedron isometric lattice. All integer coordinates in this
...
abstract public class RDGCS extends Grid {
    ...
    public RDGCS() {
        this(new Point3D(0d, 0d, 0d), new Pair<Integer, Integer>(-5, 5), 1d, new Pair<Integer, Integer>(-5, 5), 1d,
    ...
    public RDGCS(double intervalX, double intervalY, double intervalZ, Point3D origin, Pair<Integer, Integer> xExtent,
                 Pair<Integer, Integer> yExtent, Pair<Integer, Integer> zExtent, Point3D xAxis, Point3D yAxis,
                 Point3D zAxis) {
    ...
    /**
     * Calculate the cross product of the two vectors, u and v, in rdg coordinates
     *
     * @param u
     * @param v
    ...
    /**
     * Calculate the dot product of the two vectors, u and v, in rdg coordinates
     *
     * @param u
     * @param v
    ...
    /**
     * convert the rdg point to the equivalent cartesian point, preserving edge length
     *
     * @param rdg
     * @return
     */
    ...
    /**
     * convert the cartesian point to the equivalent rdg point, preserving edge length
     *
     * @param cartesian
     * @return
     */
