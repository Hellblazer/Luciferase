...
public class Icosahedron extends PlatonicSolid {
    ...
    public Icosahedron(Vector3d[] vs) {
        ...
        int[][] faces = { { 0, 1, 3 }, { 0, 2, 1 }, { 0, 3, 7 }, { 0, 7, 4 }, { 0, 4, 2 }, { 7, 10, 4 }, { 4, 10, 8 },
                          { 4, 8, 2 }, { 2, 8, 5 }, { 2, 5, 1 }, { 1, 5, 6 }, { 1, 6, 3 }, { 3, 6, 9 }, { 3, 9, 7 },
                          { 7, 9, 10 }, { 11, 10, 9 }, { 11, 8, 10 }, { 11, 5, 8 }, { 11, 6, 5 }, { 11, 9, 6 } };
        ...
        addFaces(f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19);
