...
import com.hellblazer.luciferase.sentinel.Sentinel;
import com.hellblazer.luciferase.sentinel.Tetrahedron;
...
public class SentinelView extends GraphicsView {
    ...
    private final Sentinel     tetrahedralization;
    ...
    public SentinelView(Sentinel t) {
        super();
        tetrahedralization = t;
        for (Vertex v : tetrahedralization.extent()) {
            fourCorners.add(v);
        }
        updateDiagram();
    }

    public Sentinel getTetrahedralization() {
    ...
    public void updateDiagram() {
        ...
        for (Tetrahedron t : tetrahedralization.tetrahedrons()) {
        ...
        for (Vertex v : tetrahedralization) {
        ...
        displaySpheres(tetrahedralization.stream(), 0.07, Colors.yellowMaterial, vertexes);
    }
