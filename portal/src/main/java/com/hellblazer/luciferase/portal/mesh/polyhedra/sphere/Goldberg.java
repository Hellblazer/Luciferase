...
/**
 * An approximate sphere created by projecting the vertices of a Goldberg polyhedron to the sphere of desired
 * circumradius. The Goldberg polyhedron is generated by taking the dual polyhedron of an icosphere generated with the
...
public class Goldberg extends Polyhedron {
    ...
    /**
     * Generate a Goldberg polyhedron whose vertices are projected to the sphere of given circumradius and is the dual
     * polyhedron of the icosphere with the given number of subdivisions.
     *
     * @param circumradius The distance of vertices from the origin.
     * @param subdivisions The number of subdivisions in the icosphere.
     */
