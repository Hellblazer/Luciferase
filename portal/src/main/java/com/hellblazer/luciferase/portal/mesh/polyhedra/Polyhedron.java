...
public class Polyhedron extends Mesh {
    ...
    public Polyhedron whirl() {
        ...
        for (Face face : faces) {
            ...
            for (int i = 0; i < face.numVertices(); i++) {
                ...
                hexagon.setAllVertexIndices(ends[0], edgeVertices[0], edgeVertices[1], currCenterIndex, prevCenterIndex,
                                            prevEdgeVertices[1]);
    ...
    /**
     * A helper method for implementing lace, parametrized lace, and joined-lace.
     *
     * @param n      The number of sides a face needs to have lace applied to it.
        ...
        for (Face face : faces) {
            if (ignore || face.numVertices() == n) {
                ...
                for (int i = 0; i < face.numVertices(); i++) {
                    ...
                    Vector3d newVertex = VectorMath.interpolate(vertex, centroid, 0.3);
