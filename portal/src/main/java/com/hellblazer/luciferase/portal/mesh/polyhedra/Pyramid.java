...
public class Pyramid extends Polyhedron {
    ...
    /**
     * Constructs a pyramid with a default radius (0.5) and default height (1.0). The number of sides of the base is the
     * only parameter.
     *
    ...
    /**
     * Constructs a pyramid whose base has the given circumradius and has the given height. The base is a regular n-gon,
     * where n is given as a parameter. With high enough n, the geometry is an approximate cylinder.
     *
     * @param numSides The number of sides the base has.
