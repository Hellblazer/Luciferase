...
public class SimEntityImpl implements Perceiving, SimEntity {
    ...
    protected Point3f directionFlipSteps;
    ...
    protected Point3f velocity;

    public SimEntityImpl(Random random, int thinkTime, int flipStep, float maxVelocity, int dimX, int dimY) {
        this.random = random;
        ...
        this.dimX = dimX;
        this.dimY = dimY;
        velocity = new Point3f(newDelta(), newDelta(), 0);
        directionX = random.nextBoolean();
        directionY = random.nextBoolean();
        directionFlipSteps = new Point3f(random.nextInt(flipStep), random.nextInt(flipStep), random.nextInt(flipStep));
    }
    ...
    @Override
    public void move(Perceiving neighbor, Point3f location, Vector3f velocity) {
        // TODO Auto-generated method stub

    }

    @Override
    public void notice(Perceiving neighbor, Point3f location) {
        // TODO Auto-generated method stub
