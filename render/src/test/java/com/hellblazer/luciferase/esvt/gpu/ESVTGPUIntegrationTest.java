...
class ESVTGPUIntegrationTest {
    ...
    void testChildTypeDerivation() {
        ...
        // For parent type 0 (t8code dtet labeling, RDR-010 Luciferase-4pd):
        // INDEX_TO_BEY_NUMBER[0] = {0,1,4,5,2,7,6,3} (Morton → Bey, unchanged)
        // PARENT_TYPE_TO_CHILD_TYPE[0] = {0,0,0,0,4,5,2,1} (Bey → child type, t8code type_of_child)
        ...
        // PARENT_TYPE_TO_CHILD_TYPE[3] = {3,3,3,3,5,4,1,2} (t8code type_of_child)
