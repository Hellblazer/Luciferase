package com.hellblazer.luciferase.esvo.opengl;
...
public class ESVOGLComputeTest extends GLComputeHeadlessTest {
    ...
    static void checkEnvironment() {
        // Skip all tests in this class if we're in CI or headless environment
        String ci = System.getenv("CI");
        String display = System.getenv("DISPLAY");
        String session = System.getenv("XDG_SESSION_TYPE");
        boolean isHeadless = java.awt.GraphicsEnvironment.isHeadless();
        
        if ("true".equals(ci) || display == null || isHeadless) {
            org.junit.jupiter.api.Assumptions.assumeTrue(false, 
                "Skipping OpenGL compute tests - headless environment or CI detected");
        }
    }
