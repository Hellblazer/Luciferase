 ...
 */
public class BubbleVONNode implements VONNode {
     ...
     */
    public BubbleVONNode(EnhancedBubble bubble, Consumer<VONEvent> eventEmitter) {
    ...
    @Override
    public void notifyMove(VONNode neighbor) {
        Objects.requireNonNull(neighbor, "neighbor cannot be null");

        // Emit MOVE event for this neighbor
        eventEmitter.accept(new VONEvent.Move(neighbor.id(), neighbor.position()));
    ...
    @Override
    public void notifyLeave(VONNode neighbor) {
        Objects.requireNonNull(neighbor, "neighbor cannot be null");
        ...
        // Emit LEAVE event
        eventEmitter.accept(new VONEvent.Leave(neighbor.id()));
    }

    @Override
    public void notifyJoin(VONNode neighbor) {
        Objects.requireNonNull(neighbor, "neighbor cannot be null");
        ...
        // Emit JOIN event
        eventEmitter.accept(new VONEvent.Join(neighbor.id(), neighbor.position()));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BubbleVONNode that)) return false;
    ...
    public String toString() {
        return String.format("BubbleVONNode{id=%s, position=%s, neighbors=%d}",
