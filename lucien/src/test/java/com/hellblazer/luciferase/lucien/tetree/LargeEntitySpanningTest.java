...
/**
 * Tests for memory-efficient spanning of large entities in Tetree
 * Validates Phase 3.1 Step 3 implementation
 * 
...
public class LargeEntitySpanningTest {
    ...
    void testMediumEntitySpanning() {
        ...
        var foundEntities2 = tetree.entitiesInRegion(new com.hellblazer.luciferase.lucien.Spatial.Cube(100, 100, 100, 50));
    ...
    void testLargeEntitySpanning() {
        ...
        var foundEntities2 = tetree.entitiesInRegion(new com.hellblazer.luciferase.lucien.Spatial.Cube(500, 500, 500, 100));
        var foundEntities3 = tetree.entitiesInRegion(new com.hellblazer.luciferase.lucien.Spatial.Cube(900, 900, 900, 100));
    ...
    void testVeryLargeEntityMemoryEfficiency() {
        ...
        var foundEntities = tetree.entitiesInRegion(new com.hellblazer.luciferase.lucien.Spatial.Cube(1000, 1000, 1000, 500));
        assertTrue(foundEntities.contains(entityId));
    }
    ...
    void testMultipleOverlappingLargeEntities() {
        ...
        var overlapEntities = tetree.entitiesInRegion(new com.hellblazer.luciferase.lucien.Spatial.Cube(500, 500, 500, 200));
    ...
    void testAdaptiveLevelSelection() {
        ...
        var tinyRegionLookup = tetree.entitiesInRegion(new com.hellblazer.luciferase.lucien.Spatial.Cube(100, 100, 100, 2));
        ...
        assertTrue(tinyRegionLookup.contains(tinyEntity), "Tiny entity should be found in small region around its position");
