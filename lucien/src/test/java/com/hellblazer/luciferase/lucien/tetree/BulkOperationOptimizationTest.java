...
public class BulkOperationOptimizationTest {
    ...
    void testComparisonWithAndWithoutOptimization() {
        ...
        System.out.printf("Individual insertions: %.2f ms (hit rate: %.2f%%)%n", 
                individualTime / 1_000_000.0, individualHitRate * 100);
        System.out.printf("Bulk insertion: %.2f ms (hit rate: %.2f%%)%n", 
                bulkTime / 1_000_000.0, bulkHitRate * 100);
