...
/**
 * Integration tests focused on ray intersection functionality.
 * Tests real-world usage scenarios and cross-compatibility.
 *
...
public class RayIntersectionIntegrationTest {
    ...
    void testEntitySpanningIntegration() {
        ...
        Point3f[] rayOrigins = {
            new Point3f(100, 256, 256), // From west
    ...
    void testMixedEntityTypesWithRayIntersection() {
        ...
        var pointIntersection = intersections.stream()
            .filter(inter -> inter.entityId().equals(pointId))
            .findFirst();
    ...
    void testRayIntersectionConsistencyAcrossLevels() {
        ...
        for (byte level : levels) {
            ...
            Point3f pos = new Point3f(
                basePosition.x + level * 0.1f,
                basePosition.y + level * 0.1f,
    ...
    void testRayIntersectionWithinDistance() {
        ...
        List<SpatialIndex.RayIntersection<LongEntityID, String>> withinIntersections = 
            octree.rayIntersectWithin(ray, maxDistance);
        ...
        for (var intersection : withinIntersections) {
            assertTrue(intersection.distance() <= maxDistance,
                      "All intersections should be within max distance");
        }
    }
    ...
    void testRayIntersectionAccuracyComparison() {
        ...
        EntityBounds bounds = new EntityBounds(
            new Point3f(190, 190, 190),
            new Point3f(210, 210, 210)
        );
