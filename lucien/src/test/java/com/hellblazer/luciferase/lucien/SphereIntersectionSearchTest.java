...
/**
 * Unit tests for Sphere intersection search functionality
...
public class SphereIntersectionSearchTest {
    ...
    void testSphereIntersectedAll() {
        ...
        List<SphereIntersectionSearch.SphereIntersection<String>> intersections = 
            SphereIntersectionSearch.sphereIntersectedAll(sphereCenter, sphereRadius, octree, referencePoint);
    ...
    void testSphereIntersectedFirst() {
        ...
        SphereIntersectionSearch.SphereIntersection<String> firstIntersection = 
            SphereIntersectionSearch.sphereIntersectedFirst(sphereCenter, sphereRadius, octree, referencePoint);
        
        if (firstIntersection != null) {
            // Should be the closest intersection
            List<SphereIntersectionSearch.SphereIntersection<String>> allIntersections = 
                SphereIntersectionSearch.sphereIntersectedAll(sphereCenter, sphereRadius, octree, referencePoint);
    ...
    void testCubesCompletelyInside() {
        ...
        List<SphereIntersectionSearch.SphereIntersection<String>> insideCubes = 
            SphereIntersectionSearch.cubesCompletelyInside(sphereCenter, sphereRadius, octree, referencePoint);
        
        // All results should be COMPLETELY_INSIDE
        for (var intersection : insideCubes) {
            assertEquals(SphereIntersectionSearch.IntersectionType.COMPLETELY_INSIDE, 
                        intersection.intersectionType);
        }
    ...
    void testCubesPartiallyIntersecting() {
        ...
        List<SphereIntersectionSearch.SphereIntersection<String>> intersectingCubes = 
            SphereIntersectionSearch.cubesPartiallyIntersecting(sphereCenter, sphereRadius, octree, referencePoint);
        
        // All results should be INTERSECTING
        for (var intersection : intersectingCubes) {
            assertEquals(SphereIntersectionSearch.IntersectionType.INTERSECTING, 
                        intersection.intersectionType);
        }
    ...
    void testGetSphereIntersectionStatistics() {
        ...
        SphereIntersectionSearch.IntersectionStatistics stats = 
            SphereIntersectionSearch.getSphereIntersectionStatistics(sphereCenter, sphereRadius, octree);
    ...
    void testBatchSphereIntersections() {
        ...
        Map<SphereIntersectionSearch.SphereQuery, List<SphereIntersectionSearch.SphereIntersection<String>>> results = 
            SphereIntersectionSearch.batchSphereIntersections(queries, octree, referencePoint);
    ...
    void testEmptyOctree() {
        ...
        List<SphereIntersectionSearch.SphereIntersection<String>> intersections = 
            SphereIntersectionSearch.sphereIntersectedAll(sphereCenter, sphereRadius, emptyOctree, referencePoint);
        
        assertTrue(intersections.isEmpty());
        
        SphereIntersectionSearch.SphereIntersection<String> first = 
            SphereIntersectionSearch.sphereIntersectedFirst(sphereCenter, sphereRadius, emptyOctree, referencePoint);
        ...
        SphereIntersectionSearch.IntersectionStatistics stats = 
            SphereIntersectionSearch.getSphereIntersectionStatistics(sphereCenter, sphereRadius, emptyOctree);
    ...
    void testDistanceOrdering() {
        ...
        List<SphereIntersectionSearch.SphereIntersection<String>> nearIntersections = 
            SphereIntersectionSearch.sphereIntersectedAll(sphereCenter, sphereRadius, octree, nearReference);
        
        List<SphereIntersectionSearch.SphereIntersection<String>> farIntersections = 
            SphereIntersectionSearch.sphereIntersectedAll(sphereCenter, sphereRadius, octree, farReference);
    ...
    void testSmallAndLargeSpheres() {
        ...
        List<SphereIntersectionSearch.SphereIntersection<String>> smallIntersections = 
            SphereIntersectionSearch.sphereIntersectedAll(smallCenter, smallRadius, octree, referencePoint);
        ...
        List<SphereIntersectionSearch.SphereIntersection<String>> largeIntersections = 
            SphereIntersectionSearch.sphereIntersectedAll(largeCenter, largeRadius, octree, referencePoint);
