...
public class OctreeSpanningTest {
    ...
    void testEntitySpanningTwoNodes() {
        ...
        EntityBounds bounds = new EntityBounds(
            new Point3f(cellSize - 10, 90, 90),  // Min extends into previous cell
    ...
    void testNoSpanningWhenDisabled() {
        ...
        assertEquals(1, noSpanOctree.getEntitySpanCount(id), 
            "Entity should be in one node when spanning disabled");
    }
    ...
    void testEntityRemovalFromSpannedNodes() {
        ...
        assertFalse(octree.lookup(leftCell, level).contains(id), 
            "Entity should not be found in left cell");
        assertFalse(octree.lookup(rightCell, level).contains(id), 
            "Entity should not be found in right cell");
    }
    ...
    void testBoundaryConditions() {
        ...
        assertEquals(1, octree.getEntitySpanCount(id), 
            "Point entity should be in exactly one node");
    }
}