...
/**
 * Unit tests for k-Nearest Neighbor search functionality All test coordinates use positive values only
 *
...
public class KNearestNeighborSearchTest {
    ...
    void testDistanceCalculation() {
        ...
        List<KNearestNeighborSearch.KNNCandidate<String>> results = KNearestNeighborSearch.findKNearestNeighbors(
        queryPoint, 1, testOctree);
    ...
    void testResultConsistency() {
        ...
        List<KNearestNeighborSearch.KNNCandidate<String>> results1 = KNearestNeighborSearch.findKNearestNeighbors(
        queryPoint, 3, octree);
        List<KNearestNeighborSearch.KNNCandidate<String>> results2 = KNearestNeighborSearch.findKNearestNeighbors(
        queryPoint, 3, octree);
