...
public class OctreeSubdivisionStrategyTest {
    ...
    void testInsertInParentDecision() {
        // Test at max depth
        var context = new SubdivisionStrategy.SubdivisionContext<LongEntityID>(
            12345L, (byte) 21, 5, 10, false, null, 
        ...
        context = new SubdivisionStrategy.SubdivisionContext<>(
            12345L, (byte) 10, 2, 10, false, null, 
            new ArrayList<>(), (byte) 21
        );
    ...
    void testDeferSubdivisionDecision() {
        ...
        var context = new SubdivisionStrategy.SubdivisionContext<LongEntityID>(
            12345L, (byte) 10, 12, 10, true, null, 
            new ArrayList<>(), (byte) 21
        );
    ...
    void testForceSubdivisionDecision() {
        ...
        var context = new SubdivisionStrategy.SubdivisionContext<LongEntityID>(
            12345L, (byte) 10, 25, 10, false, null, 
            new ArrayList<>(), (byte) 21
        );
    ...
    void testSplitToChildrenDecision() {
        ...
        var context = new SubdivisionStrategy.SubdivisionContext<LongEntityID>(
            0L, (byte) 10, 8, 10, false, largeBounds, 
            new ArrayList<>(), (byte) 21
        );
        ...
        var spanningContext = new SubdivisionStrategy.SubdivisionContext<LongEntityID>(
            0L, (byte) 15, 8, 10, false, largeBounds, 
            new ArrayList<>(), (byte) 21
        );
    ...
    void testCreateSingleChildDecision() {
        ...
        EntityBounds smallBounds = new EntityBounds(
        ...
        var context = new SubdivisionStrategy.SubdivisionContext<LongEntityID>(
            0L, (byte) 5, 5, 10, false, smallBounds, 
    ...
    void testCalculateTargetNodes() {
        ...
        var targetNodes = strategy.calculateTargetNodes(0L, (byte) 5, bounds, null);
        ...
        var largerBounds = new EntityBounds(
            new Point3f(0, 0, 0),
            new Point3f(2000, 2000, 2000)
        );
        
        var spanningTargets = strategy.calculateTargetNodes(0L, (byte) 10, largerBounds, null);
    ...
    void testSubdivisionBenefitEstimation() {
        ...
        var smallContext = new SubdivisionStrategy.SubdivisionContext<LongEntityID>(
            12345L, (byte) 10, 5, 10, false, null, 
            new ArrayList<>(), (byte) 21
        );
        
        var overloadedContext = new SubdivisionStrategy.SubdivisionContext<LongEntityID>(
            12345L, (byte) 10, 15, 10, false, null, 
            new ArrayList<>(), (byte) 21
        );
        
        var nearMaxDepthContext = new SubdivisionStrategy.SubdivisionContext<LongEntityID>(
            12345L, (byte) 20, 10, 10, false, null, 
            new ArrayList<>(), (byte) 21
        );
