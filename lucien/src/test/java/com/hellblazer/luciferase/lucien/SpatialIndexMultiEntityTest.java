 ...
 */
public class SpatialIndexMultiEntityTest {
    
    private SpatialIndexMultiEntity<LongEntityID, String> spatialIndex;
    
    @BeforeEach
    void setUp() {
        // Create an OctreeWithEntities instance that implements the interface
        spatialIndex = new OctreeWithEntities<>(new SequentialLongIDGenerator());
    }
