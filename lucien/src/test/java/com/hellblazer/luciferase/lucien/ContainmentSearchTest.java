...
/**
 * Unit tests for Containment search functionality
...
public class ContainmentSearchTest {
    ...
    void testCubesContainedInSphere() {
        ...
        List<ContainmentSearch.ContainmentResult<String>> results = 
            ContainmentSearch.cubesContainedInSphere(sphereCenter, sphereRadius, octree, referencePoint);
        ...
        for (int i = 0; i < results.size() - 1; i++) {
            assertTrue(results.get(i).distanceToReferencePoint <= 
                      results.get(i + 1).distanceToReferencePoint);
        }
    ...
    void testCubesContainedInAABB() {
        ...
        List<ContainmentSearch.ContainmentResult<String>> results = 
            ContainmentSearch.cubesContainedInAABB(aabb, octree, referencePoint);
    ...
    void testCubesContainedInCylinder() {
        ...
        List<ContainmentSearch.ContainmentResult<String>> results = 
            ContainmentSearch.cubesContainedInCylinder(cylinderBase, cylinderTop, cylinderRadius, octree, referencePoint);
    ...
    void testCubesWithVolumeRatio() {
        ...
        List<ContainmentSearch.ContainmentResult<String>> containedCubes = 
            ContainmentSearch.cubesContainedInSphere(sphereCenter, sphereRadius, octree, referencePoint);
        ...
        if (!containedCubes.isEmpty()) {
            ...
            List<ContainmentSearch.ContainmentResult<String>> filteredCubes = 
                ContainmentSearch.cubesWithVolumeRatio(containerVolume, 0.0f, 1.0f, containedCubes);
    ...
    void testGetContainmentStatisticsForSphere() {
        ...
        ContainmentSearch.ContainmentStatistics stats = 
            ContainmentSearch.getContainmentStatisticsForSphere(sphereCenter, sphereRadius, octree);
        ...
        assertEquals(stats.totalCubes, 
                    stats.containedCubes + stats.partiallyContainedCubes + stats.notContainedCubes);
    ...
    void testEmptyOctree() {
        ...
        List<ContainmentSearch.ContainmentResult<String>> results = 
            ContainmentSearch.cubesContainedInSphere(sphereCenter, sphereRadius, emptyOctree, referencePoint);
        ...
        ContainmentSearch.ContainmentStatistics stats = 
            ContainmentSearch.getContainmentStatisticsForSphere(sphereCenter, sphereRadius, emptyOctree);
    ...
    void testNegativeCoordinatesThrowException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            ContainmentSearch.cubesContainedInCylinder(negativeCylinderBase, positiveCylinderTop, radius, octree, positiveReference);
        });
        
        assertThrows(IllegalArgumentException.class, () -> {
            ContainmentSearch.cubesContainedInCylinder(positiveCylinderBase, positiveCylinderTop, -10.0f, octree, positiveReference);
        });
    }
    ...
    void testDistanceOrdering() {
        ...
        List<ContainmentSearch.ContainmentResult<String>> nearResults = 
            ContainmentSearch.cubesContainedInSphere(sphereCenter, sphereRadius, octree, nearReference);
        
        List<ContainmentSearch.ContainmentResult<String>> farResults = 
            ContainmentSearch.cubesContainedInSphere(sphereCenter, sphereRadius, octree, farReference);
    ...
    void testSmallAndLargeContainers() {
        ...
        List<ContainmentSearch.ContainmentResult<String>> smallResults = 
            ContainmentSearch.cubesContainedInSphere(smallCenter, smallRadius, octree, referencePoint);
        ...
        List<ContainmentSearch.ContainmentResult<String>> largeResults = 
            ContainmentSearch.cubesContainedInSphere(largeCenter, largeRadius, octree, referencePoint);
