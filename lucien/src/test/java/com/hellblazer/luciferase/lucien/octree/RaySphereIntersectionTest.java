...
public class RaySphereIntersectionTest {
    ...
    /**
     * Manual implementation of ray-sphere intersection for verification
     * Based on the algorithm from AbstractSpatialIndex.raySphereIntersection()
     */
    private float manualRaySphereIntersection(Ray3D ray, Point3f sphereCenter, float radius) {
        // Vector from ray origin to sphere center
        Vector3f oc = new Vector3f(sphereCenter.x - ray.origin().x, 
                                   sphereCenter.y - ray.origin().y, 
    ...
    void testRayOriginInsideSphere() {
        ...
        // Debug step by step
        Vector3f oc = new Vector3f(entityPos.x - rayOrigin.x, 
                                   entityPos.y - rayOrigin.y, 
                                   entityPos.z - rayOrigin.z);
        System.out.println("Ray origin: " + rayOrigin);
    ...
    void testDebugCalculationSteps() {
        ...
        Point3f closestPoint = new Point3f(rayOrigin.x + t * rayDirection.x,
