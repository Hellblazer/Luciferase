...
/**
 * Unit tests for Ray tracing intersection search functionality All test coordinates use positive values only
 *
...
public class RayTracingSearchTest {
    ...
    void testDistanceOrderingCorrectness() {
        ...
        List<RayTracingSearch.RayIntersection<String>> intersections = RayTracingSearch.rayIntersectedAll(ray, octree);
    ...
    void testEmptyOctree() {
        ...
        List<RayTracingSearch.RayIntersection<String>> intersections = RayTracingSearch.rayIntersectedAll(ray,
                                                                                                          emptyOctree);

        assertTrue(intersections.isEmpty());

        RayTracingSearch.RayIntersection<String> firstIntersection = RayTracingSearch.rayIntersectedFirst(ray,
                                                                                                          emptyOctree);
    ...
    void testRayIntersectedFirst() {
        ...
        RayTracingSearch.RayIntersection<String> firstIntersection = RayTracingSearch.rayIntersectedFirst(ray, octree);
