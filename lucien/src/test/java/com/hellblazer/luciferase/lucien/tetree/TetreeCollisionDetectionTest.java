...
/**
 * Comprehensive tests for Tetree collision detection functionality.
 * Tests basic collision detection, bounded entities, and tetrahedral-specific scenarios.
 *
...
public class TetreeCollisionDetectionTest {
    ...
    void testNonOverlappingBoundedEntities() {
        ...
        EntityBounds bounds2 = new EntityBounds(
            new Point3f(290, 290, 290),
            new Point3f(310, 310, 310)
        );
    ...
    void testTetrahedralSpacePartitioning() {
        ...
        Point3f[] positions = {
            new Point3f(64, 64, 64),    // Different tetrahedral regions
            new Point3f(128, 128, 128),
            new Point3f(192, 192, 192),
        ...
        for (int i = 0; i < entityIds.length; i++) {
            for (int j = i + 1; j < entityIds.length; j++) {
                Optional<SpatialIndex.CollisionPair<LongEntityID, String>> collision = 
                    tetree.checkCollision(entityIds[i], entityIds[j]);
                assertFalse(collision.isPresent(), 
                    "Entities in different tetrahedral regions should not collide");
            }
        }
    }
    ...
    void testFindCollisionsForSpecificEntity() {
        ...
        Point3f[] surroundingPositions = {
            ...
            new Point3f(500, 500, 500) // This one should not collide
        };
        ...
        List<SpatialIndex.CollisionPair<LongEntityID, String>> distantCollisions = tetree.findCollisions(surroundingIds[3]);
    ...
    void testCollisionWithNonExistentEntity() {
        ...
        Optional<SpatialIndex.CollisionPair<LongEntityID, String>> collision = tetree.checkCollision(existingId, nonExistentId);
    ...
    void testTetrahedralReferenceSystem() {
        ...
        Point3f[] tetraPositions = {
            new Point3f(32, 32, 32),    // S0 tetrahedron regions
            new Point3f(64, 32, 32),
            new Point3f(32, 64, 32),
            new Point3f(32, 32, 64)
        };
