...
/**
 * Tests to validate the effectiveness of caching optimizations implemented in 2025. Specifically tests
 * TetreeLevelCache, SpatialIndexSet, and other O(1) optimizations.
 *
 * @author hal.hildebrand
 */
public class CacheEffectivenessTest
extends AbstractSpatialIndexPerformanceTest<com.hellblazer.luciferase.lucien.octree.MortonKey, LongEntityID, String> {
    ...
    protected SpatialIndex<com.hellblazer.luciferase.lucien.octree.MortonKey, LongEntityID, String> createSpatialIndex(
    ...
    void testCacheEffectivenessAcrossDistributions() {
        ...
        SpatialDistribution[] distributions = { SpatialDistribution.UNIFORM_RANDOM, SpatialDistribution.CLUSTERED,
        ...
        for (SpatialDistribution distribution : distributions) {
            ...
            PerformanceMetrics distributionMetrics = measure("cache_" + distribution.name().toLowerCase(), 2000, () -> {
                // Insert entities
            ...
            System.out.printf("Cache with %s distribution: %.0f ops/sec%n", distribution,
                              distributionMetrics.getOperationsPerSecond());
    ...
    void testCacheMemoryEfficiency() {
        ...
        PerformanceMetrics memoryMetrics = measure("cache_memory_efficiency", 5000, () -> {
        ...
        assertTrue(memoryPerEntity < 2000, "Cache memory overhead should be reasonable per entity");
    }
    ...
    void testCacheScaling(int datasetSize) {
        ...
        PerformanceMetrics cacheScalingMetrics = measure("cache_scaling_" + datasetSize, datasetSize, () -> {
            ...
            for (int i = 0; i < queryCount; i++) {
                ...
                tetree.entitiesInRegion(
                new com.hellblazer.luciferase.lucien.Spatial.Cube(cubeOriginX, cubeOriginY, cubeOriginZ, cubeExtent));
            }
        });
    ...
    void testSpatialIndexSetPerformance() {
        ...
        PerformanceMetrics spatialIndexSetMetrics = measure("spatial_index_set_operations", 3000, () -> {
            ...
            for (int i = 0; i < 50; i++) {
                ...
                float originZ = i * 20;
                float extent = 20;
                octree.entitiesInRegion(
                new com.hellblazer.luciferase.lucien.Spatial.Cube(originX, originY, originZ, extent));
            }
        });
    ...
    void testTetreeLevelCacheEffectiveness() {
        ...
        PerformanceMetrics levelCacheMetrics = measure("tetree_level_cache_operations", CACHE_TEST_SIZE, () -> {
        ...
        System.out.printf("TetreeLevelCache test: %.2fms for %d entities + queries (%.0f ops/sec)%n",
                          levelCacheMetrics.getElapsedMillis(), CACHE_TEST_SIZE,
                          levelCacheMetrics.getOperationsPerSecond());
