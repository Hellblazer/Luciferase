...
/**
 * Unit tests for Algorithm Optimizer functionality All test coordinates use positive values only
 *
...
public class AlgorithmOptimizerTest {
    ...
    void testAdaptiveKNNStrategies() {
        ...
        for (int i = 0; i < 10; i++) {
            Point3f testPoint = new Point3f(queryPoint.x + (i - 5) * 10.0f, queryPoint.y + (i - 5) * 10.0f,
                                            queryPoint.z + (i - 5) * 10.0f);
            adaptiveKNN.findKNearest(testPoint, 3);
        }

        // Check that performance metrics are being tracked
        Map<AlgorithmOptimizer.AdvancedSpatialSearch.SearchStrategy, AlgorithmOptimizer.PerformanceMetrics> metrics = adaptiveKNN.getPerformanceMetrics();
    ...
    void testAdaptiveKNearestNeighbor() {
        ...
        AlgorithmOptimizer.AdvancedSpatialSearch.KNNResult<String> result = adaptiveKNN.findKNearest(queryPoint, k);
        ...
        AlgorithmOptimizer.AdvancedSpatialSearch.KNNResult<String> smallK = adaptiveKNN.findKNearest(queryPoint, 1);
    ...
    void testAdaptiveRangeQuery() {
        ...
        AlgorithmOptimizer.AdvancedSpatialSearch.RangeQueryResult<String> largeResult = adaptiveRange.rangeQuery(
        minBounds, largeBounds);
    ...
    void testAlgorithmConsistency() {
        ...
        AlgorithmOptimizer.AdvancedSpatialSearch.KNNResult<String> result1 = adaptiveKNN.findKNearest(queryPoint, k);
        AlgorithmOptimizer.AdvancedSpatialSearch.KNNResult<String> result2 = adaptiveKNN.findKNearest(queryPoint, k);
    ...
    void testCacheNullHandling() {
        ...
        AlgorithmOptimizer.IntelligentCache<String, String> cache = new AlgorithmOptimizer.IntelligentCache<>(5, 1000,
                                                                                                              AlgorithmOptimizer.IntelligentCache.CacheEvictionStrategy.LRU,
                                                                                                              sizeEstimator);
    ...
    void testCacheStatisticsCalculations() {
        AlgorithmOptimizer.IntelligentCache.CacheStatistics stats = new AlgorithmOptimizer.IntelligentCache.CacheStatistics(
        8, 10, 15, 5, 3, 800, 1000);
    ...
    void testDistanceEntry() {
        AlgorithmOptimizer.AdvancedSpatialSearch.DistanceEntry<String> entry1 = new AlgorithmOptimizer.AdvancedSpatialSearch.DistanceEntry<>(
        5.0f, "content1");
        AlgorithmOptimizer.AdvancedSpatialSearch.DistanceEntry<String> entry2 = new AlgorithmOptimizer.AdvancedSpatialSearch.DistanceEntry<>(
        3.0f, "content2");
    ...
    void testIntelligentCacheAdaptive() {
        ...
        AlgorithmOptimizer.IntelligentCache<String, String> cache = new AlgorithmOptimizer.IntelligentCache<>(2, 1000,
                                                                                                              AlgorithmOptimizer.IntelligentCache.CacheEvictionStrategy.ADAPTIVE,
                                                                                                              sizeEstimator);
    ...
    void testIntelligentCacheLFU() {
        ...
        AlgorithmOptimizer.IntelligentCache<String, String> cache = new AlgorithmOptimizer.IntelligentCache<>(2, 1000,
                                                                                                              AlgorithmOptimizer.IntelligentCache.CacheEvictionStrategy.LFU,
                                                                                                              sizeEstimator);
    ...
    void testIntelligentCacheLRU() {
        ...
        AlgorithmOptimizer.IntelligentCache<String, String> cache = new AlgorithmOptimizer.IntelligentCache<>(3, 1000,
                                                                                                              AlgorithmOptimizer.IntelligentCache.CacheEvictionStrategy.LRU,
                                                                                                              sizeEstimator);
    ...
    void testIntelligentCacheMemoryLimit() {
        ...
        AlgorithmOptimizer.IntelligentCache<String, String> cache = new AlgorithmOptimizer.IntelligentCache<>(10, 20,
                                                                                                              AlgorithmOptimizer.IntelligentCache.CacheEvictionStrategy.LRU,
                                                                                                              sizeEstimator);
    ...
    void testIntelligentCacheSizeBased() {
        ...
        AlgorithmOptimizer.IntelligentCache<String, String> cache = new AlgorithmOptimizer.IntelligentCache<>(3, 1000,
                                                                                                              AlgorithmOptimizer.IntelligentCache.CacheEvictionStrategy.SIZE_BASED,
                                                                                                              sizeEstimator);
    ...
    void testSearchStrategyAdaptation() {
        ...
        boolean hasValidMetrics = metrics.values().stream().anyMatch(
        m -> m.getTotalExecutions() > 0 && m.getAverageTimeNanos() > 0);
