...
/**
 * Tests for advanced spanning policies and strategies in Tetree
 * Validates Phase 3.1 Step 4 implementation
 * 
...
public class AdvancedSpanningPolicyTest {
    ...
    void testAdaptivePolicy() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            var entityId = idGenerator.generateID();
            tetree.insert(entityId, new Point3f(i * 50 + 20, i * 50 + 20, i * 50 + 20), (byte) 4, 
                         "adaptive-test-" + i, bounds);
        }
    ...
    void testPolicyComparison() {
        ...
        var defaultTetree = new Tetree<>(defaultGenerator, 10, (byte) 8, 
        ...
        var memoryTetree = new Tetree<>(memoryGenerator, 10, (byte) 8, 
                                      EntitySpanningPolicy.memoryOptimized());
        ...
        var perfTetree = new Tetree<>(perfGenerator, 10, (byte) 8, 
                                    EntitySpanningPolicy.performanceOptimized());
    ...
    void testAdvancedSpanningThresholds() {
        ...
        for (float entitySize : entitySizes) {
            ...
            System.out.printf("Entity size %.1f: Empty=%b, Medium=%b, Heavy=%b%n", 
                            entitySize, shouldSpanEmpty, shouldSpanMedium, shouldSpanHeavy);
        }
    }
