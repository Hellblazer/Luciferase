...
public class ParallelSpatialProcessorTest {
    ...
    void testEmptyOctreeParallelQueries() {
        ...
        try {
            ...
            ParallelSpatialProcessor.ParallelResult<String> knnResult = emptyExecutor.parallelKNearestNeighborQuery(
            queryPoint, 5);
            ...
            ParallelSpatialProcessor.ParallelResult<String> rangeResult = emptyExecutor.parallelRangeQuery(minBounds,
                                                                                                           maxBounds);
    ...
    void testNegativeCoordinatesThrowException() {
        ...
        List<Point3f> pointsWithNegative = List.of(new Point3f(100.0f, 100.0f, 100.0f), negativePoint);

        ParallelSpatialProcessor.ParallelConfig config = ParallelSpatialProcessor.ParallelConfig.defaultConfig();

        assertThrows(IllegalArgumentException.class, () -> {
            ParallelSpatialProcessor.ParallelSpatialDataProcessor.parallelMortonEncoding(pointsWithNegative, config);
        });
    }
    ...
    void testParallelConfig() {
        // Test default config
        ParallelSpatialProcessor.ParallelConfig defaultConfig = ParallelSpatialProcessor.ParallelConfig.defaultConfig();
        ...
        ParallelSpatialProcessor.ParallelConfig conservativeConfig = ParallelSpatialProcessor.ParallelConfig.conservativeConfig();
        ...
        ParallelSpatialProcessor.ParallelConfig aggressiveConfig = ParallelSpatialProcessor.ParallelConfig.aggressiveConfig();
    ...
    void testParallelConfigValidation() {
        ...
        ParallelSpatialProcessor.ParallelConfig config = new ParallelSpatialProcessor.ParallelConfig(0, 0, 0, true,
                                                                                                     500);
    ...
    void testParallelCustomQuery() {
        ...
        ParallelSpatialProcessor.ParallelResult<String> result = parallelExecutor.parallelCustomQuery(
        entry -> entry.getValue().contains("Dense"));
    ...
    void testParallelDataTransform() {
        ...
        ParallelSpatialProcessor.ParallelResult<Integer> result = ParallelSpatialProcessor.ParallelSpatialDataProcessor.parallelTransform(
        ...
        ParallelSpatialProcessor.ParallelResult<Integer> smallResult = ParallelSpatialProcessor.ParallelSpatialDataProcessor.parallelTransform(
    ...
    void testParallelKNearestNeighborQuery() {
        ...
        ParallelSpatialProcessor.ParallelResult<String> result = parallelExecutor.parallelKNearestNeighborQuery(
        queryPoint, k);
        ...
        ParallelSpatialProcessor.ParallelResult<String> largeKResult = parallelExecutor.parallelKNearestNeighborQuery(
        queryPoint, 1000);
    ...
    void testParallelMortonEncoding() {
        ...
        ParallelSpatialProcessor.ParallelResult<Long> result = ParallelSpatialProcessor.ParallelSpatialDataProcessor.parallelMortonEncoding(
        points, config);
    ...
    void testParallelPerformanceMonitor() {
        ParallelSpatialProcessor.ParallelPerformanceMonitor monitor = new ParallelSpatialProcessor.ParallelPerformanceMonitor();

        // Initially no statistics
        ParallelSpatialProcessor.ParallelPerformanceMonitor.ParallelPerformanceStats initialStats = monitor.getStatistics();
        assertEquals(0, initialStats.totalExecutions);

        // Record some successful executions
        List<String> results = List.of("result1", "result2");
        ParallelSpatialProcessor.ParallelResult<String> successResult = new ParallelSpatialProcessor.ParallelResult<>(
        results, 2_000_000L, 2, 1, false, null);
        monitor.recordExecution(successResult);

        ParallelSpatialProcessor.ParallelResult<String> anotherResult = new ParallelSpatialProcessor.ParallelResult<>(
        results, 3_000_000L, 3, 2, false, null);
        monitor.recordExecution(anotherResult);

        // Record a failed execution
        ParallelSpatialProcessor.ParallelResult<String> failedResult = new ParallelSpatialProcessor.ParallelResult<>(
        List.of(), 1_000_000L, 0, 0, false, new RuntimeException("test error"));
        monitor.recordExecution(failedResult);

        // Record a timed out execution
        ParallelSpatialProcessor.ParallelResult<String> timedOutResult = new ParallelSpatialProcessor.ParallelResult<>(
        List.of(), 5_000_000L, 2, 0, true, null);
        monitor.recordExecution(timedOutResult);

        ParallelSpatialProcessor.ParallelPerformanceMonitor.ParallelPerformanceStats stats = monitor.getStatistics();
        ...
        ParallelSpatialProcessor.ParallelPerformanceMonitor.ParallelPerformanceStats clearedStats = monitor.getStatistics();
    ...
    void testParallelRadiusQuery() {
        ...
        ParallelSpatialProcessor.ParallelResult<String> result = parallelExecutor.parallelRadiusQuery(queryCenter,
                                                                                                      radius);
        ...
        ParallelSpatialProcessor.ParallelResult<String> smallResult = parallelExecutor.parallelRadiusQuery(queryCenter,
                                                                                                           1.0f);
    ...
    void testParallelRangeQuery() {
        ...
        ParallelSpatialProcessor.ParallelResult<String> result = parallelExecutor.parallelRangeQuery(minBounds,
                                                                                                     maxBounds);
        ...
        ParallelSpatialProcessor.ParallelResult<String> largeResult = parallelExecutor.parallelRangeQuery(minBounds,
                                                                                                          largeBounds);
    ...
    void testParallelResult() {
        ...
        ParallelSpatialProcessor.ParallelResult<String> result = new ParallelSpatialProcessor.ParallelResult<>(results,
                                                                                                               5_000_000L,
                                                                                                               4, 2,
                                                                                                               false,
                                                                                                               null);
        ...
        ParallelSpatialProcessor.ParallelResult<String> failedResult = new ParallelSpatialProcessor.ParallelResult<>(
        List.of(), 1_000_000L, 0, 0, false, error);
        ...
        ParallelSpatialProcessor.ParallelResult<String> timedOutResult = new ParallelSpatialProcessor.ParallelResult<>(
        List.of(), 10_000_000L, 2, 0, true, null);
    ...
    void testParallelSpatialAnalysis() {
        ...
        ParallelSpatialProcessor.ParallelResult<SpatialIndexOptimizer.SpatialDistributionStats> result = ParallelSpatialProcessor.ParallelSpatialDataProcessor.parallelSpatialAnalysis(
        points, config);
    ...
    void testSequentialFallback() {
        ...
        try {
            ...
            ParallelSpatialProcessor.ParallelResult<String> result = fallbackExecutor.parallelRadiusQuery(queryCenter,
                                                                                                          50.0f);
    ...
    void testShutdownBehavior() {
        ...
        ParallelSpatialProcessor.ParallelConfig nonWorkStealingConfig = new ParallelSpatialProcessor.ParallelConfig(2,
                                                                                                                    100,
                                                                                                                    50,
                                                                                                                    false,
                                                                                                                    30000);
    ...
    void testWorkChunkSizeImpact() {
        ...
        ParallelSpatialProcessor.ParallelConfig smallChunkConfig = new ParallelSpatialProcessor.ParallelConfig(4, 50,
                                                                                                               10, true,
                                                                                                               30000);

        ParallelSpatialProcessor.ParallelConfig largeChunkConfig = new ParallelSpatialProcessor.ParallelConfig(4, 50,
                                                                                                               100,
                                                                                                               true,
                                                                                                               30000);
        ...
        try {
            ...
            ParallelSpatialProcessor.ParallelResult<String> smallChunkResult = smallChunkExecutor.parallelRadiusQuery(
            queryCenter, 100.0f);

            ParallelSpatialProcessor.ParallelResult<String> largeChunkResult = largeChunkExecutor.parallelRadiusQuery(
            queryCenter, 100.0f);
