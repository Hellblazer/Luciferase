...
/**
 * Unit tests for Visibility search functionality All test coordinates use positive values only
 *
...
public class VisibilitySearchTest {
    ...
    void testCalculateVisibilityStatistics() {
        ...
        VisibilitySearch.VisibilityStatistics stats = VisibilitySearch.calculateVisibilityStatistics(observer,
                                                                                                     maxViewDistance,
                                                                                                     octree);
        ...
        assertTrue(stats.totalCubes >= stats.visibleCubes + stats.partiallyOccludedCubes + stats.fullyOccludedCubes
        + stats.cubesOutOfRange);
    ...
    void testEmptyOctree() {
        ...
        VisibilitySearch.LineOfSightResult<String> losResult = VisibilitySearch.testLineOfSight(observer, target,
                                                                                                emptyOctree, 10.0f);
        ...
        List<VisibilitySearch.VisibilityResult<String>> visibleCubes = VisibilitySearch.findVisibleCubes(observer,
                                                                                                         viewDirection,
                                                                                                         (float) Math.PI
                                                                                                         / 4, 1000.0f,
                                                                                                         emptyOctree);
        ...
        VisibilitySearch.VisibilityStatistics stats = VisibilitySearch.calculateVisibilityStatistics(observer, 1000.0f,
                                                                                                     emptyOctree);
    ...
    void testFindBestVantagePoints() {
        Point3f target = new Point3f(300.0f, 300.0f, 300.0f);
        List<Point3f> candidatePositions = List.of(new Point3f(100.0f, 100.0f, 100.0f),
                                                   new Point3f(200.0f, 200.0f, 200.0f),
                                                   new Point3f(400.0f, 400.0f, 400.0f),
                                                   new Point3f(250.0f, 250.0f, 100.0f));

        List<VisibilitySearch.VantagePoint> vantagePoints = VisibilitySearch.findBestVantagePoints(target,
                                                                                                   candidatePositions,
                                                                                                   octree);
    ...
    void testFindVisibleCubes() {
        ...
        for (int i = 0; i < visibleCubes.size() - 1; i++) {
            assertTrue(visibleCubes.get(i).distanceFromObserver <= visibleCubes.get(i + 1).distanceFromObserver);
        }
    ...
    void testInvalidParameters() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            VisibilitySearch.findVisibleCubes(observer, viewDirection, (float) Math.PI + 0.1f, 1000.0f, octree);
        });

        // Test negative max view distance
        assertThrows(IllegalArgumentException.class, () -> {
            VisibilitySearch.findVisibleCubes(observer, viewDirection, (float) Math.PI / 4, -100.0f, octree);
        });
    ...
    void testLineOfSight() {
        ...
        VisibilitySearch.LineOfSightResult<String> result = VisibilitySearch.testLineOfSight(observer, target, octree,
                                                                                             occlusionThreshold);
        ...
        for (int i = 0; i < result.occludingCubes.size() - 1; i++) {
            assertTrue(
            result.occludingCubes.get(i).distanceFromObserver <= result.occludingCubes.get(i + 1).distanceFromObserver);
        }
    ...
    void testLineOfSightSamePoint() {
        ...
        VisibilitySearch.LineOfSightResult<String> result = VisibilitySearch.testLineOfSight(samePoint, samePoint,
                                                                                             octree,
                                                                                             occlusionThreshold);
    ...
    void testNegativeCoordinatesThrowException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            VisibilitySearch.findVisibleCubes(negativeObserver, viewDirection, (float) Math.PI / 4, 1000.0f, octree);
        });
    ...
    void testVantagePointScoring() {
        ...
        List<Point3f> candidatePositions = List.of(new Point3f(290.0f, 290.0f, 290.0f), // Very close
