...
public class OctreeHashMapOptimizationTest {
    ...
    void performanceComparison() {
        ...
        System.out.printf("  Inserted %d entities in %.2f ms (%.2f μs/op)%n", 
            entityCount, insertTime / 1_000_000.0, insertTime / 1000.0 / entityCount);
        System.out.printf("  Performed %d lookups in %.2f ms (%.2f μs/op)%n", 
            lookupCount, lookupTime / 1_000_000.0, lookupTime / 1000.0 / lookupCount);
