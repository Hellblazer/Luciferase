...
public class OctreeRayIntersectionTest {
    ...
    void testRayIntersectionWithinDistance() {
        ...
        List<SpatialIndex.RayIntersection<LongEntityID, String>> nearIntersections = 
        ...
        List<SpatialIndex.RayIntersection<LongEntityID, String>> allIntersections = 
            octree.rayIntersectWithin(ray, 1000.0f);
    ...
    void testRayFromEntityCenter() {
        ...
        LongEntityID entityId = octree.insert(entityPos, (byte) 10, "CenterEntity");
    ...
    void testDifferentLevels() {
        ...
        LongEntityID id1 = octree.insert(pos1, (byte) 8, "CoarseLevel");  // Coarse level
        LongEntityID id2 = octree.insert(pos2, (byte) 15, "FineLevel");   // Fine level
