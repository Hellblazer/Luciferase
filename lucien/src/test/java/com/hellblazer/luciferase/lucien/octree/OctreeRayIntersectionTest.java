...
public class OctreeRayIntersectionTest {
    ...
    void testRayIntersectionWithinDistance() {
        ...
        List<SpatialIndex.RayIntersection<LongEntityID, String>> nearIntersections = octree.rayIntersectWithin(ray,
                                                                                                               maxDistance);
        ...
        List<SpatialIndex.RayIntersection<LongEntityID, String>> allIntersections = octree.rayIntersectWithin(ray,
                                                                                                              1000.0f);
