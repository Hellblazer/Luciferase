...
/**
 * Comprehensive tests for TetrahedralGeometry
 * Tests ray-tetrahedron intersection, frustum culling, plane intersection, and other geometric operations
 */
...
public class TetrahedralGeometryTest {
    ...
    void testRay3DCreation() {
        ...
        assertThrows(IllegalArgumentException.class, () -> 
            new TetrahedralGeometry.Ray3D(origin, direction, -1.0f));
    }
    ...
    void testFrustum3DCreation() {
        ...
        assertThrows(IllegalArgumentException.class, () -> 
            new TetrahedralGeometry.Frustum3D(new Point3f(-1.0f, 10.0f, 10.0f), forward, up, right, near, far, fovY, aspect));
    }
