...
/**
 * Test the new deterministic tetrahedral classification algorithm.
 * This will replace the non-deterministic "test all 6" approach in locate().
 */
public class DeterministicTetClassificationTest {
     ...
     * This is the PRODUCTION algorithm used in Tetree.locate().
     * 
