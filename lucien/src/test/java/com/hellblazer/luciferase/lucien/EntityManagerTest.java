...
public class EntityManagerTest {
    ...
    void testEntitiesWithPositions() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> 
            actualMap.put(new LongEntityID(999), new Point3f())
        );
    }
    ...
    void testFindEntitiesInRegion() {
        ...
        List<LongEntityID> entitiesInRegion = entityManager.findEntitiesInRegion(
            150, 350,  // x range: 150-350
        ...
        // Test empty region
        List<LongEntityID> emptyRegion = entityManager.findEntitiesInRegion(
    ...
    void testNullHandling() {
        ...
        assertThrows(NullPointerException.class, () -> 
            new EntityManager<LongEntityID, String>(null)
        );
        
        // Test null storage map
        assertThrows(NullPointerException.class, () -> 
            new EntityManager<>(idGenerator, null)
        );
    }
}