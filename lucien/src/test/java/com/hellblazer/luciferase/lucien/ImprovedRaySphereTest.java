...
public class ImprovedRaySphereTest {
    ...
    void testMultipleDistances() {
        ...
        for (float dist : distances) {
            Point3f entityPos = new Point3f(50 + dist / (float) Math.sqrt(3), 50 + dist / (float) Math.sqrt(3),
            ...
            System.out.printf("%8.1f | %8.2f | %8.2f | %8.2f%n", dist, original, improved, geometric);
        }
    }
    ...
    private float geometricRaySphere(Point3f rayOrigin, Vector3f rayDir, Point3f center, float radius) {
        ...
        Point3f closestPoint = new Point3f(rayOrigin.x + t * rayDir.x, rayOrigin.y + t * rayDir.y,
