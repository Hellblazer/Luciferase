...
/**
 * Spatial distribution patterns for performance testing.
 * Based on C++ Octree benchmark distributions.
 *
        ...
        public List<Point3f> generate(int count, VolumeBounds bounds) {
            ...
            for (int i = 0; i < count; i++) {
                points.add(new Point3f(
                    bounds.minX() + rand.nextFloat() * width,
                    bounds.minY() + rand.nextFloat() * height,
        ...
        public List<Point3f> generate(int count, VolumeBounds bounds) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                Point3f point = new Point3f(
                    Math.max(bounds.minX(), Math.min(bounds.maxX(), center.x + dx)),
        ...
        public List<Point3f> generate(int count, VolumeBounds bounds) {
            ...
            for (int i = 2; i < count; i++) {
                ...
                points.add(new Point3f(
                    ...
                    bounds.minZ() + rand.nextFloat() * height
                ));
            }
