...
public class StackBasedTreeBuilderTest {
    ...
    void testBottomUpConstruction() {
        ...
        var config = StackBasedTreeBuilder.defaultConfig()
                .withStrategy(StackBasedTreeBuilder.BuildStrategy.BOTTOM_UP);
        octree.configureTreeBuilder(config);
        ...
        assertTrue(octree.entityCount() == 100, "All entities should be inserted");
    }
    ...
    void testHybridConstruction() {
        ...
        var config = StackBasedTreeBuilder.defaultConfig()
                .withStrategy(StackBasedTreeBuilder.BuildStrategy.HYBRID);
        octree.configureTreeBuilder(config);
        ...
        // Verify tree was built
        assertTrue(octree.nodeCount() > 0, "Tree should have nodes");
        assertTrue(octree.entityCount() == 500, "All entities should be inserted");
    }
}
