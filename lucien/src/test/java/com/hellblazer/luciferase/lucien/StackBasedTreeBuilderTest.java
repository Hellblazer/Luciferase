...
public class StackBasedTreeBuilderTest {
    ...
    void testLargeBulkBuild() {
        ...
        var nearbyEntities = octree.kNearestNeighbors(
            new Point3f(5000, 5000, 5000), 10, 1000
        );
    ...
    void testDifferentBuildStrategies() {
        ...
        var topDownConfig = StackBasedTreeBuilder.defaultConfig()
            .withStrategy(StackBasedTreeBuilder.BuildStrategy.TOP_DOWN);
        ...
        var noSortConfig = StackBasedTreeBuilder.defaultConfig()
            .withPreSortEntities(false);
    ...
    void testProgressTracking() {
        ...
        var config = StackBasedTreeBuilder.defaultConfig()
        ...
        var builder = new StackBasedTreeBuilder<LongEntityID, String, com.hellblazer.luciferase.lucien.octree.OctreeNode<LongEntityID>>(
            config, octree::getLevelFromIndex
        );
    ...
    void testMemoryEfficientConfig() {
        ...
        var nearbyInCluster0 = octree.entitiesInRegion(new Spatial.Cube(cluster0Center.x - 100, cluster0Center.y - 100, cluster0Center.z - 100, 200));
