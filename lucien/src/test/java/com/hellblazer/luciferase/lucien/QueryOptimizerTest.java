...
/**
 * Unit tests for Query Optimizer functionality All test coordinates use positive values only
 *
...
public class QueryOptimizerTest {
    ...
    void testQueryExecutionPlanner() {
        ...
        SpatialIndexOptimizer.SpatialDistributionStats dataStats = new SpatialIndexOptimizer.SpatialDistributionStats(
        100, 50.0f, 500.0f, 50.0f, 500.0f, 50.0f, 500.0f, (byte) 15, 2, 0.7f);
    ...
    void testQueryMetrics() {
        QueryOptimizer.QueryMetrics metrics = new QueryOptimizer.QueryMetrics("test", 1_000_000L, 10, 50, false);
    ...
    void testQueryPerformanceBenchmark() {
        ...
        List<Point3f> queryPoints = QueryOptimizer.QueryPerformanceBenchmark.generateRandomQueryPoints(10, 100.0f,
                                                                                                       400.0f);
        ...
        QueryOptimizer.QueryPerformanceBenchmark.BenchmarkResult radiusResult = QueryOptimizer.QueryPerformanceBenchmark.benchmarkRadiusQueries(
        queryEngine, queryPoints, 50.0f);
        ...
        QueryOptimizer.QueryPerformanceBenchmark.BenchmarkResult knnResult = QueryOptimizer.QueryPerformanceBenchmark.benchmarkKNNQueries(
        queryEngine, queryPoints, 3);
    ...
    @Test
    void testQueryPlan() {
        QueryOptimizer.QueryPlan plan = new QueryOptimizer.QueryPlan(QueryOptimizer.QueryStrategy.MORTON_ORDERED, 16,
                                                                     true, false, 25.5f);
    ...
    void testQueryPlannerWithDifferentDataDistributions() {
        ...
        SpatialIndexOptimizer.SpatialDistributionStats clusteredStats = new SpatialIndexOptimizer.SpatialDistributionStats(
        1000, 100.0f, 300.0f, 100.0f, 300.0f, 100.0f, 300.0f, (byte) 14, 5, 0.2f); // Low uniformity, many clusters
        ...
        SpatialIndexOptimizer.SpatialDistributionStats uniformStats = new SpatialIndexOptimizer.SpatialDistributionStats(
        1000, 100.0f, 500.0f, 100.0f, 500.0f, 100.0f, 500.0f, (byte) 15, 1, 0.8f); // High uniformity, few clusters
        ...
        SpatialIndexOptimizer.SpatialDistributionStats sparseStats = new SpatialIndexOptimizer.SpatialDistributionStats(
        50, 100.0f, 1000.0f, 100.0f, 1000.0f, 100.0f, 1000.0f, (byte) 12, 1, 0.9f); // Few points, large space
    ...
    void testRandomQueryPointGeneration() {
        ...
        List<Point3f> singlePoint = QueryOptimizer.QueryPerformanceBenchmark.generateRandomQueryPoints(1, 100.0f,
                                                                                                       100.1f);
