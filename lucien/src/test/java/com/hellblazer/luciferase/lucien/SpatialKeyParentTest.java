...
public class SpatialKeyParentTest {
    ...
    void testTetreeKeyParent() {
        ...
        TetreeKey greatGrandparent = grandparent.parent();
    ...
    void testTetreeKeyBitShifting() {
        ...
        TetreeKey level9 = new TetreeKey((byte) 9, 0x123456789ABCDEFL, 0L);
        TetreeKey parent9to8 = level9.parent();
        ...
        TetreeKey level10 = new TetreeKey((byte) 10, 0xFFFFFFFFFFFFFFFFL, 0x0L);
        TetreeKey parent10to9 = level10.parent();
        ...
        TetreeKey level11 = new TetreeKey((byte) 11, 0xAAAAAAAAAAAAAAAAL, 0xBBL); // highBits has 6 bits for level 10
        TetreeKey parent11to10 = level11.parent();
