...
/**
 * Comprehensive tests for Octree collision detection functionality. Tests basic collision detection, bounded entities,
 * and edge cases.
 *
...
public class OctreeCollisionDetectionTest {
    ...
    void testCollisionWithNonExistentEntity() {
        ...
        Optional<SpatialIndex.CollisionPair<LongEntityID, String>> collision = octree.checkCollision(existingId,
                                                                                                     nonExistentId);
    ...
    void testFindCollisionsForSpecificEntity() {
        ...
        100, 100, 100.05f), new Point3f(200, 200, 200) // This one should not collide
        };
        ...
        List<SpatialIndex.CollisionPair<LongEntityID, String>> distantCollisions = octree.findCollisions(
        surroundingIds[3]);
    ...
    void testMixedEntityTypeCollisions() {
        ...
        // Test collision detection
        Optional<SpatialIndex.CollisionPair<LongEntityID, String>> collision = octree.checkCollision(pointId,
                                                                                                     boundedId);
    ...
    void testNonOverlappingBoundedEntities() {
        ...
        EntityBounds bounds1 = new EntityBounds(new Point3f(90, 90, 90), new Point3f(110, 110, 110));
        EntityBounds bounds2 = new EntityBounds(new Point3f(140, 140, 140), new Point3f(160, 160, 160));
