...
public class TreeTraversalTest {
    ...
    public void testEntityCollectorVisitor() {
        ...
        EntityCollectorVisitor<LongEntityID, String> visitor = 
            new EntityCollectorVisitor<>(content -> content.startsWith("EVEN"));
    ...
    public void testVisitorCallbacks() {
        ...
        assertTrue(callOrder.stream().anyMatch(s -> s.startsWith("visitNode")),
                  "Should have node visits");
        assertTrue(callOrder.stream().anyMatch(s -> s.startsWith("leaveNode")),
                  "Should have leave node calls");
    }
    ...
    public void testCancellation() {
        ...
        for (int i = 0; i < 200; i++) {
            ...
            Point3f pos = new Point3f(
                (i % 10) * 1000,  // Create spatial separation
                ((i / 10) % 10) * 1000,
                ((i / 100) % 10) * 1000
            );
