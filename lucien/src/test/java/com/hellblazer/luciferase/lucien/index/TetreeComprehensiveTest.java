...
/**
 * Comprehensive tests for Tetree implementation using Bey red refinement.
 * Tests spatial indexing, tetrahedral space-filling curve properties, and geometric consistency.
 * 
...
public class TetreeComprehensiveTest {
    ...
    void testMultipleInsertionsAndSpatialDistribution() {
        ...
        Point3f[] points = {
            ...
            new Point3f(150.0f, 250.0f, 350.0f),
            new Point3f(50.0f, 150.0f, 250.0f)
        };
    ...
    void testLevelAndCoordinateConsistency() {
        ...
        for (byte level = 5; level <= 15; level++) {
            ...
            assertTrue(tet.x() % expectedLength == 0, "X should be quantized to grid");
            assertTrue(tet.y() % expectedLength == 0, "Y should be quantized to grid");
            assertTrue(tet.z() % expectedLength == 0, "Z should be quantized to grid");
        }
    }
