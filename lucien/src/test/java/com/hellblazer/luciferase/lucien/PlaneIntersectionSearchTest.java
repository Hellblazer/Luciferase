...
/**
 * Unit tests for Plane intersection search functionality All test coordinates use positive values only
 *
...
public class PlaneIntersectionSearchTest {
    ...
    void testComplexPlaneIntersection() {
        ...
        List<PlaneIntersectionSearch.PlaneIntersection<String>> intersections = PlaneIntersectionSearch.planeIntersectedAll(
        diagonalPlane, octree, referencePoint);
        ...
        List<PlaneIntersectionSearch.PlaneIntersection<String>> positiveSide = PlaneIntersectionSearch.cubesOnPositiveSide(
        diagonalPlane, octree, referencePoint);

        List<PlaneIntersectionSearch.PlaneIntersection<String>> negativeSide = PlaneIntersectionSearch.cubesOnNegativeSide(
        diagonalPlane, octree, referencePoint);
    ...
    void testCubesOnNegativeSide() {
        ...
        for (int i = 0; i < negativeSide.size() - 1; i++) {
            assertTrue(
            negativeSide.get(i).distanceToReferencePoint <= negativeSide.get(i + 1).distanceToReferencePoint);
        }
    }
    ...
    void testCubesOnPositiveSide() {
        ...
        for (int i = 0; i < positiveSide.size() - 1; i++) {
            assertTrue(
            positiveSide.get(i).distanceToReferencePoint <= positiveSide.get(i + 1).distanceToReferencePoint);
        }
    }
    ...
    void testDistanceOrdering() {
        ...
        List<PlaneIntersectionSearch.PlaneIntersection<String>> nearIntersections = PlaneIntersectionSearch.planeIntersectedAll(
        plane, octree, nearReference);

        List<PlaneIntersectionSearch.PlaneIntersection<String>> farIntersections = PlaneIntersectionSearch.planeIntersectedAll(
        plane, octree, farReference);
    ...
    void testEmptyOctree() {
        ...
        List<PlaneIntersectionSearch.PlaneIntersection<String>> intersections = PlaneIntersectionSearch.planeIntersectedAll(
        plane, emptyOctree, referencePoint);

        assertTrue(intersections.isEmpty());

        PlaneIntersectionSearch.PlaneIntersection<String> first = PlaneIntersectionSearch.planeIntersectedFirst(plane,
                                                                                                                emptyOctree,
                                                                                                                referencePoint);
    ...
    void testPlaneIntersectedAllByPlaneDistance() {
        ...
        List<PlaneIntersectionSearch.PlaneIntersection<String>> intersections = PlaneIntersectionSearch.planeIntersectedAllByPlaneDistance(
        plane, octree);
    ...
    void testPlaneIntersectedFirst() {
        ...
        PlaneIntersectionSearch.PlaneIntersection<String> firstIntersection = PlaneIntersectionSearch.planeIntersectedFirst(
        plane, octree, referencePoint);

        if (firstIntersection != null) {
            // Should be the closest intersection
            List<PlaneIntersectionSearch.PlaneIntersection<String>> allIntersections = PlaneIntersectionSearch.planeIntersectedAll(
            plane, octree, referencePoint);
