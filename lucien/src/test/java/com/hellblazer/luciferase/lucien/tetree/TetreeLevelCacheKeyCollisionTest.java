 ...
 *
 * The current implementation has a bug in the cache key generation: long key = ((long) x << 32) | ((long) y << 16) |
 * ((long) z) | ((long) level << 8) | type;
 *
...
public class TetreeLevelCacheKeyCollisionTest {
    ...
    public void testCorrectBitPacking() {
        ...
        long correctKey = ((long) (x & 0xFFFF) << 48) | ((long) (y & 0xFFFF) << 32) | ((long) (z & 0xFFFF) << 16) | (
        (long) (level & 0xFF) << 8) | (type & 0xFF);
