...
public class TetContainsTest {
    ...
    void testContainsConsistency() {
        ...
        // Test various points
        var testPoints = new Point3f[] { new Point3f(150, 150, 150), new Point3f(0, 0, 0), new Point3f(0, 2048, 0),
                                         new Point3f(0, 2048, 2048), new Point3f(2048, 0, 2048), new Point3f(1024, 1024,
                                                                                                             1024),
                                         new Point3f(500, 500, 500), new Point3f(2000, 2000, 2000) };
    ...
    void testInteriorPoints() {
        ...
        assertTrue(tet3.contains(new Point3f(150, 150, 150)), "Type 3 should contain interior point (150,150,150)");
        ...
        assertFalse(tet3.contains(new Point3f(10000, 10000, 10000)), "Should not contain point far outside");
    }
    ...
    void testNegativeCoordinates() {
        ...
        var cellSize = 1 << (MortonCurve.MAX_REFINEMENT_LEVEL - 10); // 2048
