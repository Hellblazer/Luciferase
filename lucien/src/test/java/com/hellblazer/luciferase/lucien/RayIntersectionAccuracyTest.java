...
/**
 * Accuracy and integration tests for ray intersection functionality.
 * Tests cross-compatibility between Octree and Tetree implementations
 * and validates mathematical accuracy of intersection calculations.
 *
...
public class RayIntersectionAccuracyTest {
    ...
    void testBoundedEntityAccuracy() {
        ...
        EntityBounds bounds = new EntityBounds(
            new Point3f(180, 180, 180), 
            new Point3f(220, 220, 220)
        );
    ...
    void testIntersectionPointAccuracy() {
        ...
        EntityBounds bounds = new EntityBounds(
            new Point3f(140, 90, 90),
            new Point3f(160, 110, 110)
        );
    ...
    void testRayIntersectFirstConsistency() {
        ...
        if (!octreeAll.isEmpty()) {
            assertTrue(octreeFirst.isPresent(), "rayIntersectFirst should be present when rayIntersectAll finds intersections");
        ...
        if (!tetreeAll.isEmpty()) {
            assertTrue(tetreeFirst.isPresent(), "Tetree: rayIntersectFirst should be present when rayIntersectAll finds intersections");
    ...
    void testRayWithinDistanceAccuracy() {
        ...
        Point3f[] positions = {
            new Point3f(110, 110, 110), // Distance ≈ 86.6
        ...
        // Test Octree
        List<SpatialIndex.RayIntersection<LongEntityID, String>> octreeWithin = octree.rayIntersectWithin(ray, maxDistance);
        ...
        // Test Tetree
        List<SpatialIndex.RayIntersection<LongEntityID, String>> tetreeWithin = tetree.rayIntersectWithin(ray, maxDistance);
    ...
    void testNumericalStability() {
        ...
        Point3f[] testPositions = {
            new Point3f(1.0f, 1.0f, 1.0f),           // Small coordinates
