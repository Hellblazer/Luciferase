...
public class LazyEvaluationPerformanceTest {
    ...
    void testInsertionPerformanceComparison() {
        ...
        // Print results
        System.out.printf("Regular insertion: %.2f ms (%.2f μs/entity)%n", 
            regularTime / 1_000_000.0, regularTime / 1000.0 / testPositions.size());
        System.out.printf("Lazy insertion: %.2f ms (%.2f μs/entity)%n", 
            lazyTime / 1_000_000.0, lazyTime / 1000.0 / testPositions.size());
    ...
    void testQueryPerformance() {
        ...
        System.out.printf("\nQuery found %d neighbors in %.2f ms%n", 
            neighbors.size(), queryTime / 1_000_000.0);
