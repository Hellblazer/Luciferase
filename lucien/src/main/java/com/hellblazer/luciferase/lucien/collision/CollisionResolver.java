...
/**
 * Resolves collisions between entities using physics-based calculations.
 * Supports different collision response types and material properties.
 *
...
public class CollisionResolver {
     ...
     */
    public record CollisionConfig(
        float defaultMass,
        float defaultRestitution,
        float defaultFriction,
        boolean enablePositionCorrection,
        boolean enableFriction,
        float positionCorrectionPercent,
        float positionCorrectionSlop
    ) {
     ...
     */
    public <ID extends EntityID, Content> CollisionResponse resolveCollision(
            CollisionPair<ID, Content> collision,
        ...
        return new CollisionResponse(
            ...
            restitution, config.defaultFriction
        );
    }
     ...
     */
    private void applyFriction(CollisionPair<?, ?> collision, Vector3f relativeVelocity,
                              float normalImpulse, Vector3f impulse1, Vector3f impulse2,
                              float mass1, float mass2) {
     ...
     */
    public <ID extends EntityID, Content> CollisionResponse resolveStaticCollision(
            CollisionPair<ID, Content> collision,
     ...
     */
    public <ID extends EntityID, Content> Vector3f calculateSeparation(
            CollisionPair<ID, Content> collision,
            float mass1, float mass2) {
