...
public class Constants {
    ...
    /* RDR-010 Luciferase-4pd: t8code dtet type_of_child_morton — verified =
     * PARENT_TYPE_TO_CHILD_TYPE[parent][INDEX_TO_BEY_NUMBER[parent][morton]] under t8code labeling. */
