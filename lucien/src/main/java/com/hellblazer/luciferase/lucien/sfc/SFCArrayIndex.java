...
public class SFCArrayIndex<ID extends EntityID, Content> extends AbstractSpatialIndex<MortonKey, ID, Content> {
    ...
    /**
     * Original simple cells(Q) implementation - enumerates all cells.
     * Kept for comparison and fallback for small queries.
     */
    public List<MortonKeyInterval> cellsQSimple(VolumeBounds queryBounds, byte level) {
