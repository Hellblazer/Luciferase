 ...
 * 
 * Morton codes provide a space-filling curve that maps 3D coordinates to
 * a single dimension while preserving spatial locality. The Morton code
 * inherently encodes both the spatial location and the hierarchical level.
 * 
 * This implementation wraps the existing long Morton code to provide
 * type safety and compatibility with the generic SpatialKey interface.
 * 
...
public final class MortonKey implements SpatialKey<MortonKey> {
    ...
    public boolean equals(Object o) {
        ...
        MortonKey mortonKey = (MortonKey) o;
    ...
    /**
     * Factory method to create a MortonKey from coordinates and level.
     * This is a convenience method that delegates to Morton curve calculation.
     * 
