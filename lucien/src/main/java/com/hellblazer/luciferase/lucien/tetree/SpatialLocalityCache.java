...
/**
 * Spatial locality cache that pre-computes neighborhoods to exploit spatial access patterns.
 * When accessing one tetrahedron, it's likely that nearby tetrahedra will be accessed soon,
 * so we pre-compute and cache their TetreeKeys.
 *
...
public class SpatialLocalityCache {
    ...
    /**
     * Pre-cache the neighborhood around a center tetrahedron.
     * This improves performance for operations that access nearby tetrahedra.
     *
    ...
    /**
     * Pre-cache neighborhoods for multiple tetrahedra.
     * Useful for operations that will access several regions.
     *
    ...
    /**
     * Pre-cache along a ray path for ray traversal operations.
     * This anticipates the tetrahedra that will be visited during ray marching.
     *
