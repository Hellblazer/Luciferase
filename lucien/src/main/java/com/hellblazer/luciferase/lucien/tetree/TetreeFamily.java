...
/**
 * Family relationship operations for tetrahedral trees.
 * A family consists of 8 tetrahedra that share the same parent and can be merged.
 * Based on t8code's family relationship algorithms.
 * 
...
public class TetreeFamily {
     ...
     * A valid family consists of all 8 children of the same parent.
     * 
     ...
     * Siblings are the other 7 tetrahedra that share the same parent.
     * 
    ...
    /**
     * Check if a set of tetrahedra can be merged (i.e., they form a complete family).
     * This is used by tree balancing algorithms.
     * 
