...
/**
 * Neighbor finding algorithms for tetrahedral trees.
 * Implements t8code's face neighbor finding using connectivity tables.
 * 
...
public class TetreeNeighborFinder {
    ...
    /**
     * Find neighbors at a different refinement level.
     * This handles the case where neighbors may be coarser or finer.
     * 
     * @param tet The tetrahedron to find neighbors of
