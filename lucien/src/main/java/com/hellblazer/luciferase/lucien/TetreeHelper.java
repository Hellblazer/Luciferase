...
public class TetreeHelper {
    ...
    /**
     * Direct scan approach for finding simplices within bounds This is a workaround for the current issue with
     * Tetree.boundedBy()
     */
    public static <Content> Stream<Tetree.Simplex<Content>> directScanBoundedBy(Tetree<Content> tetree,
                                                                                Spatial.aabb bounds) {
