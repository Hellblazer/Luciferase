...
/**
 * Represents the axis-aligned bounding box of a spatial volume. This is a shared utility record used by multiple
...
public record VolumeBounds(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
    ...
    public static VolumeBounds from(Spatial volume) {
        return switch (volume) {
            ...
            case Spatial.aabt aabt -> aabt.toVolumeBounds();
