...
- ~~The deep-tet fail-loud guard (Finding #16) remains in place; no silent enablement.~~ **[SUPERSEDED 2026-05-31 — there is no fail-loud guard; deep cross-shape was implemented (cjwr/2l04) but is infrastructure-only, not consumed by live locate. Gap analysis confirmed. Fate tracked by RDR-012; t8code parity oracle for the deep path tracked by remediation P1 (`Luciferase-8xus`).]**
